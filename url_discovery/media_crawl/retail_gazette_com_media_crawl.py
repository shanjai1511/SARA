...
ARTICLE_PATHS = ['/blog/']
SKIP_SEGMENTS = ['page', 'tag', 'author', 'category', 'search', 'feed', 'topic', 'video', 'gallery', 'photo', 'quiz', 'newsletter', 'wp-content', 'wp-json']


class RetailGazetteComMediaCrawl():

    def get_pagination_url(self, keyurl, depth, current_depth_level):
        pagination_url = [keyurl]
        try:
            pagination_url += wordpress_pages(keyurl, count=12)
